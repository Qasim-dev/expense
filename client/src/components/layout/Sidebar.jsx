...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    },
    {
      section: 'Tools',
      items: [
        { name: 'Insight', path: '/insight', icon: 'chart' },
        { name: 'Analytics', path: '/analytics', icon: 'bar' },
      ],
    },
    {
      section: 'Other',
      items: [
        { name: 'Setting', path: '/settings', icon: 'gear' },
        { name: 'Help Center', path: '/help', icon: 'info' },
        { name: 'Support', path: '/support', icon: 'headphone' },
      ],
    },
  ];
      ...
      <nav className="p-4 pt-4 space-y-6 text-slate-700 dark:text-slate-300">
        ...
        <div className="mt-8 p-4 bg-indigo-50 dark:bg-slate-800 rounded-lg border border-indigo-100 dark:border-slate-700">
          ...
          <p className="text-xs text-indigo-700 mb-3">
            Upgrade to pro plan + Get 1 month more
          </p>
          <button className="w-full bg-indigo-600 text-white text-sm font-medium py-2 px-4 rounded-lg hover:bg-indigo-700 transition-colors">
            Upgrade Now
          </button>
        </div>
      </nav>
